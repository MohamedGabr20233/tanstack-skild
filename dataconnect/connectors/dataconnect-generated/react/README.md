...
## GetSkills
You can execute the `GetSkills` Query using the following Query hook function, which is defined in [..\..\src\dataconnect-generated/react/index.d.ts](./index.d.ts):
...
To access the data returned by a Query, use the `UseQueryResult.data` field. The data for the `GetSkills` Query is of type `GetSkillsData`, which is defined in [..\..\src\dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
